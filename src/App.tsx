      ...
      <div className="col-span-1 md:grid md:grid-cols-2 lg:grid-cols-1 w-full gap-4 ">
        ...
        >
          <img
            ...
            className="w-full lg:w-72 xl:w-96 h-full rounded-lg shadow shadow-white hover:shadow-slate-200 hover:shadow-lg hover:scale-105 transition-all duration-200"
            alt="gif de notebook"
          />
        </motion.div>
      </div>
